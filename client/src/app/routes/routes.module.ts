...
const appRoutes: Routes = [
  { path: '', redirectTo: 'connect', pathMatch: 'prefix' },
  {
    path: 'connect', component: MainUserComponent, canActivate: [AuthGuard], children:
      [
        ...
        { path: 'flow', component: FlowPageComponent , canActivate: [AuthGuard]}
      ]
  },
